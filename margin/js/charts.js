/* Margin, chart primitives. Classic script; exposes window.MarginCharts.
   ...
   - marks are blue, the one mark the chart is about is route red, the insight band is yellow;
...
(function () {
  ...
  function axisX(s, x, y, ticks, fmt, o) {
    o = o || {};
    el('line', { x1: o.from != null ? o.from : x.range[0], x2: o.to != null ? o.to : x.range[1], y1: y, y2: y, stroke: C.ink, 'stroke-width': 0.2 }, s);
    ticks.forEach(function (t) {
      el('line', { x1: x(t), x2: x(t), y1: y, y2: y + 1, stroke: C.ink, 'stroke-width': 0.2 }, s);
  ...
  function axisY(s, y, x, ticks, fmt, o) {
    o = o || {};
    if (o.line !== false) el('line', { x1: x, x2: x, y1: y.range[0], y2: y.range[1], stroke: C.ink, 'stroke-width': 0.2 }, s);
    ticks.forEach(function (t) {
      if (o.grid) el('line', { x1: x, x2: o.grid, y1: y(t), y2: y(t), stroke: C.deep, 'stroke-width': 0.2 }, s);
  ...
  function mark(s, shape, x, y, r, o) {
    ...
    else if (shape === 'ring') n = el('circle', { cx: x, cy: y, r: r - 0.3, fill: C.paper, stroke: fill, 'stroke-width': 0.39 }, s);
    else if (shape === 'half') {
      n = el('g', {}, s);
      el('circle', { cx: x, cy: y, r: r - 0.3, fill: C.paper, stroke: fill, 'stroke-width': 0.39 }, n);
  ...
  function note(s, x, y, tx, ty, str, o) {
    o = o || {};
    el('path', { d: 'M' + x + ' ' + y + ' L' + tx + ' ' + ty, stroke: C.red, 'stroke-width': 0.2, fill: 'none' }, s);
