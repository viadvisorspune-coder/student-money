...
- `css/fonts.css` and `fonts/` hold Nunito Sans (400, 500, 600, italic), the closest free match to Avenir Next, self-hosted under the SIL Open Font Licence. It is the only typeface. It carries the ₹ sign in its Latin Extended file.
